...
public enum EErrorType {
    ...
    PERSONAL_NOT_FOUND(2003,"Personal not found", BAD_REQUEST),
    ...
    COMPANY_ADMIN_NOT_EXIST(3100,"Company Admin Not Exist", INTERNAL_SERVER_ERROR),
    ...
    COMPANY_NOT_EXIST(3101,"Company not exist", BAD_REQUEST),
